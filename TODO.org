...
- project
  ...
  - assets/
    - <users static assets>
** TODO make it so that templates are loaded and usable even when not in the rust project's directory. using include_dir or something
...
** TODO fix all IDs ending in 01 
** TODO fix possible edge case where multiple nodes are created at once, adn they all have the same id
