...
** TODO when opening a file, find its root, and check if it has a project
...
** TODO when loading a project, load all data associated with it (config, nodes, build/nodes, build/links)
** TODO watch for changes on all omni related files, and in that case mutate the Project
** TODO Add link completion
** TODO Add Hover
hovering over a link will show a preview of the referenced file.
** TODO Add link go to definition
** TODO Add code action to pretty much run new
