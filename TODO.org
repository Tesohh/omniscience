...
** TODO speed up full builds
** TODO make full build take less (eg. parallel compiles, incremental compiles...)
** TODO use https://github.com/ParkMyCar/compact_str for IDs
* CLI
